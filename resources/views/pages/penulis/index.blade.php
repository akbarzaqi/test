    ...
    <div class="content-wrapper">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <a href="{{ route('penulis.create') }}" class="btn btn-secondary mb-3">Create Book</a>
                            ...
                            <table class="table table-hover scroll-horizontal-vertical w-100" id="crudTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $pns->nama_penulis }}</td>
                                        <td class="text-center">
                                          <div class="row justify-content-center ">
                                            <div class="col-12 col-lg-3">
                                              <a href="{{ route('penulis.edit', $pns->id) }}"
                                                    class="btn mr-2 mb-2 py-2 btn btn-secondary w-100">Edit</a>
                                            </div>
                                            <div class="col-12 col-lg-3">
                                              <form action="{{ route('penulis.destroy', $pns->id) }}" method="post">
                                                    @csrf
                                                    @method('delete')
